...
void GameUpdate(){
    ...
    isColliding = HitboxAxisCollisionCheck(&rect1, &rect2, &x, &y);
}
...
void GameDraw(){
    ...
    DrawLine((int)(rect1.x+rect1.w), (int)rect1.y, (int)(rect1.x+rect1.w+x), (int)(rect1.y+y), BLACK);
    DrawLine((int)(rect1.x+rect1.w), (int)(rect1.y+rect1.h), (int)(rect1.x+rect1.w+x), (int)(rect1.y+rect1.h+y), BLACK);
    DrawLine((int)(rect1.x), (int)(rect1.y+rect1.h), (int)(rect1.x+x), (int)(rect1.y+rect1.h+y), BLACK);
